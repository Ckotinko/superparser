...
static const uint16_t cvt_koi8[128] = {
    0x2500,0x2502,0x250C,0x2510,0x2514,0x2518,0x251C,0x2524,
    0x252C,0x252C,0x2534,0x253C,0x2580,0x2584,0x2588,0x258C,
...
parser_8bit::parser_8bit(const graph &g_, const config &cfg_, encoding e)
    :base_parser(g_,cfg_)
{
    switch(e) {
...
parser_8bit::~parser_8bit()
{
}
void parser_8bit::input(const char *data, size_t size, size_t &consumed)
{
    size_t i = 0;
    try {
        for(; i < size; ++i) {
